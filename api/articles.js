...
export default async function handler(req, res) {
  switch (req.method) {
    case 'GET': return await getArticles(req, res);
    case 'POST': return await createArticle(req, res);
    case 'PUT': return await updateArticle(req, res);
    case 'DELETE': return await deleteArticle(req, res);
    default:
