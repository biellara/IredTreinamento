document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ferramentasBtn) {
        ferramentasBtn.addEventListener('click', function(event) {
            ...
            // Aqui, no futuro, adicionaremos a lógica para mostrar o dashboard de ferramentas.
        });
    }
    ...
    if (conhecimentoBtn) {
        conhecimentoBtn.addEventListener('click', function(event) {
            ...
            // Aqui, no futuro, adicionaremos a lógica para mostrar a base de conhecimento.
        });
    }
    ...
    if (atividadesBtn) {
        atividadesBtn.addEventListener('click', function(event) {
            ...
            // Aqui, no futuro, adicionaremos a lógica para mostrar os artigos e atividades.
        });
    }
