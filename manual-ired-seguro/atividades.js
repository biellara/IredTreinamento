document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderCategories() {
        ...
        activityDatabase.forEach(category => {
            ...
            category.articles.forEach(article => {
                articlesHTML += `
                    <a href="#" class="kb-article-card" data-file="${article.file}" data-title="${article.title}">
    ...
    async function renderArticle(articleFile, articleTitle) {
        ...
        try {
            const response = await fetch(`./atividades/${articleFile}`);
    ...
    function addCardListeners() {
        document.querySelectorAll('.kb-article-card').forEach(card => {
            card.addEventListener('click', (e) => {
                ...
                const articleTitle = card.dataset.title;
                renderArticle(articleFile, articleTitle);
            });
        });
    }
